...
main:
    ...
    la $fp, 0($sp)
    la $sp, -8($sp)
# stack offset after '__var_array_entry_030__' is 1
# stack offset after '__var_array_entry_029__' is 8
# stack offset after '__var_array_entry_028__' is 9
# stack offset after '__var_array_entry_027__' is 16
# stack offset after '__var_array_entry_026__' is 17
# stack offset after '__var_array_entry_025__' is 24
# stack offset after '__var_array_entry_024__' is 25
# stack offset after '__var_array_entry_023__' is 32
# stack offset after '__var_array_entry_022__' is 33
# stack offset after '__var_array_entry_021__' is 40
# stack offset after 'u' is 44
# stack offset after 'x' is 64
# stack offset after final alignment is 64
    la $sp, -64($sp)
...
# OP_ASSIGN_FROM_ARRAY | __y | __var_array_entry_021__ | __var_array_entry_022__
    la $t0, __y
    lw $t1, 36($sp)
    sll $t3, $t1, 0
    add $t4, $t3, $t0
...
# OP_ASSIGN_FROM_ARRAY | x | __var_array_entry_022__ | __var_array_entry_023__
    la $t0, 44($sp)
    lb $t1, 32($sp)
    sll $t3, $t1, 2
    add $t4, $t3, $t0
...
# OP_ASSIGN_FROM_ARRAY | __y | __var_array_entry_023__ | __var_array_entry_024__
    la $t0, __y
    lw $t1, 28($sp)
    sll $t3, $t1, 0
    add $t4, $t3, $t0
...
# OP_ASSIGN_FROM_ARRAY | x | __var_array_entry_024__ | __var_array_entry_025__
    la $t0, 44($sp)
    lb $t1, 24($sp)
    sll $t3, $t1, 2
    add $t4, $t3, $t0
...
# OP_ASSIGN_FROM_ARRAY | __y | __var_array_entry_025__ | __var_array_entry_026__
    la $t0, __y
    lw $t1, 20($sp)
    sll $t3, $t1, 0
    add $t4, $t3, $t0
...
# OP_ASSIGN_FROM_ARRAY | x | __var_array_entry_026__ | __var_array_entry_027__
    la $t0, 44($sp)
    lb $t1, 16($sp)
    sll $t3, $t1, 2
    add $t4, $t3, $t0
...
# OP_ASSIGN_FROM_ARRAY | __y | __var_array_entry_027__ | __var_array_entry_028__
    la $t0, __y
    lw $t1, 12($sp)
    sll $t3, $t1, 0
    add $t4, $t3, $t0
...
# OP_ASSIGN_FROM_ARRAY | x | __var_array_entry_028__ | __var_array_entry_029__
    la $t0, 44($sp)
    lb $t1, 8($sp)
    sll $t3, $t1, 2
    add $t4, $t3, $t0
...
# OP_ASSIGN_FROM_ARRAY | __y | __var_array_entry_029__ | __var_array_entry_030__
    la $t0, __y
    lw $t1, 4($sp)
    sll $t3, $t1, 0
    add $t4, $t3, $t0
