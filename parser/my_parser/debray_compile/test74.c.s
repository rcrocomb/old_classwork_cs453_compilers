...
# stack offset after 'x' is 208
# stack offset after final alignment is 208
    la $sp, -208($sp)
...
# OP_ASSIGN_FROM_ARRAY | x | __var_func_return_006__ | __var_array_entry_007__
    la $t0, 168($sp)
    lw $t1, 148($sp)
    sll $t3, $t1, 2
    add $t4, $t3, $t0
...
# OP_ASSIGN_FROM_ARRAY | x | __var_func_return_008__ | __var_array_entry_009__
    la $t0, 168($sp)
    lw $t1, 140($sp)
    sll $t3, $t1, 2
    add $t4, $t3, $t0
...
# OP_ASSIGN_FROM_ARRAY | x | __var_func_return_010__ | __var_array_entry_011__
    la $t0, 168($sp)
    lw $t1, 132($sp)
    sll $t3, $t1, 2
    add $t4, $t3, $t0
...
# OP_ASSIGN_FROM_ARRAY | x | __var_func_return_012__ | __var_array_entry_013__
    la $t0, 168($sp)
    lw $t1, 124($sp)
    sll $t3, $t1, 2
    add $t4, $t3, $t0
...
# OP_ASSIGN_FROM_ARRAY | x | __var_add_result_017__ | __var_array_entry_018__
    la $t0, 168($sp)
    lw $t1, 112($sp)
    sll $t3, $t1, 2
    add $t4, $t3, $t0
...
# OP_ASSIGN_FROM_ARRAY | x | __var_add_result_023__ | __var_array_entry_024__
    la $t0, 168($sp)
    lw $t1, 96($sp)
    sll $t3, $t1, 2
    add $t4, $t3, $t0
...
# OP_ASSIGN_FROM_ARRAY | x | __var_add_result_029__ | __var_array_entry_030__
    la $t0, 168($sp)
    lw $t1, 80($sp)
    sll $t3, $t1, 2
    add $t4, $t3, $t0
...
# OP_ASSIGN_TO_ARRAY | x | __var_add_result_035__ | __var_add_result_037__
    la  $t0, 168($sp)
    lw $t1, 60($sp)
...
# OP_ASSIGN_FROM_ARRAY | x | __var_add_result_041__ | __var_array_entry_042__
    la $t0, 168($sp)
    lw $t1, 52($sp)
    sll $t3, $t1, 2
    add $t4, $t3, $t0
...
# OP_ASSIGN_FROM_ARRAY | x | __var_add_result_047__ | __var_array_entry_048__
    la $t0, 168($sp)
    lw $t1, 36($sp)
    sll $t3, $t1, 2
    add $t4, $t3, $t0
...
# OP_ASSIGN_FROM_ARRAY | x | __var_add_result_053__ | __var_array_entry_054__
    la $t0, 168($sp)
    lw $t1, 20($sp)
    sll $t3, $t1, 2
    add $t4, $t3, $t0
...
# OP_ASSIGN_FROM_ARRAY | x | __var_add_result_059__ | __var_array_entry_060__
    la $t0, 168($sp)
    lw $t1, 4($sp)
    sll $t3, $t1, 2
    add $t4, $t3, $t0
