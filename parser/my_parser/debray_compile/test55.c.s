...
# stack offset after '__var_func_return_016__' is 16
# stack offset after '__var_unary_MINUS_result_015__' is 20
# stack offset after '__var_func_return_013__' is 24
# stack offset after '__var_func_return_012__' is 28
# stack offset after '__var_func_return_010__' is 32
...
# OP_CALL_FUNCTION | __add | __function___temp_function_000__ | __var_func_return_010__
...
# OP_CALL_FUNCTION | __add | __function___temp_function_001__ | __var_func_return_012__
...
# OP_CALL_FUNCTION | __add | __function___temp_function_002__ | __var_func_return_013__
    lw $t2, 24($sp)
    sw $t2, -4($sp)
...
# OP_NEGATIVE | __var_intcon_014__ | No src2 | __var_unary_MINUS_result_015__
    lw $t0, __var_intcon_014__
    neg $t2, $t0
    sw $t2, 16($sp)

# OP_CALL_FUNCTION | __add | __function___temp_function_003__ | __var_func_return_016__
    lw $t2, 16($sp)
    sw $t2, -4($sp)
    lw $t2, 20($sp)
    sw $t2, -8($sp)
