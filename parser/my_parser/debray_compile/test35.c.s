...
# OP_ASSIGN_TO_ARRAY | x | __var_intcon_002__ | __var_intcon_003__
    la  $t0, 44($sp)
...
# OP_ASSIGN_TO_ARRAY | x | __var_intcon_006__ | __var_intcon_007__
    la  $t0, 44($sp)
...
# OP_ASSIGN_TO_ARRAY | x | __var_intcon_010__ | __var_intcon_011__
    la  $t0, 44($sp)
...
# OP_ASSIGN_TO_ARRAY | x | __var_intcon_014__ | __var_intcon_015__
    la  $t0, 44($sp)
...
# OP_ASSIGN_TO_ARRAY | x | __var_intcon_018__ | __var_intcon_019__
    la  $t0, 44($sp)
...
# OP_ASSIGN_FROM_ARRAY | x | __var_array_entry_021__ | __var_array_entry_022__
    la $t0, 44($sp)
    lw $t1, 36($sp)
    sll $t3, $t1, 2
    add $t4, $t3, $t0
...
# OP_ASSIGN_FROM_ARRAY | x | __var_array_entry_023__ | __var_array_entry_024__
    la $t0, 44($sp)
    lw $t1, 28($sp)
    sll $t3, $t1, 2
    add $t4, $t3, $t0
...
# OP_ASSIGN_FROM_ARRAY | x | __var_array_entry_025__ | __var_array_entry_026__
    la $t0, 44($sp)
    lw $t1, 20($sp)
    sll $t3, $t1, 2
    add $t4, $t3, $t0
...
# OP_ASSIGN_FROM_ARRAY | x | __var_array_entry_027__ | __var_array_entry_028__
    la $t0, 44($sp)
    lw $t1, 12($sp)
    sll $t3, $t1, 2
    add $t4, $t3, $t0
...
# OP_ASSIGN_FROM_ARRAY | x | __var_array_entry_029__ | __var_array_entry_030__
    la $t0, 44($sp)
    lw $t1, 4($sp)
    sll $t3, $t1, 2
    add $t4, $t3, $t0
