...
# OP_ASSIGN | __var_intcon_002__ | No src2 | __y
...
# OP_ASSIGN | __var_add_result_005__ | No src2 | __y
    lw $t0, 8($sp)
    sb $t0, __y
# OP_DUMMY | No src1 | No src2 | __y
...
# OP_ADD | __y | __var_func_return_007__ | __var_add_result_008__
    lb $t0, __y
    lb $t1, 4($sp)
    add $t2, $t0, $t1
    sw $t2, 0($sp)

# OP_ASSIGN | __var_add_result_008__ | No src2 | __x
    lw $t0, 0($sp)
    sw $t0, __x
# OP_DUMMY | No src1 | No src2 | __x
