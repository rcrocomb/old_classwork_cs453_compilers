...
# OP_ASSIGN_TO_ARRAY | y | __var_intcon_000__ | __var_intcon_001__
    la  $t0, 12($sp)
...
# OP_ASSIGN_FROM_ARRAY | y | __var_intcon_003__ | __var_array_entry_004__
    la $t0, 12($sp)
...
# OP_DUMMY | No src1 | No src2 | __var_array_entry_004__
# OP_ASSIGN_TO_ARRAY | __x | __var_intcon_002__ | __var_array_entry_004__
    la  $t0, __x
    lw $t1, 4($sp)
...
# OP_ASSIGN_FROM_ARRAY | __x | __var_intcon_005__ | __var_array_entry_006__
    la $t0, __x
