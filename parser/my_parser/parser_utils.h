...
#define PNAME(a) (a)->name().c_str()
#define NAME(a) (a).name().c_str()
...
namespace parser_utils
{
    ...
    void runtime(const unsigned int line,
                 const char * const file,
                 const char * const msg);

    std::string variable_name(const char * const c = 0);
    std::string array_name(const char * const c = 0);
    std::string label_name(const char * const c = 0);
    std::string function_name(const char * const c = 0);
